...
public class VideoScaler {
    ...
    public static Matrix getVideoScaleMatrix(float viewWidth, float viewHeight, float videoWidth, float videoHeight, int scaleType) {
        ...
        if (scaleType == FIT_CENTER) {
            ...
            scaleX = getFitCenterX(viewWidth, viewHeight, videoWidth, videoHeight, diffX, diffY, videoAspectRatio);
            scaleY = getFitCenterY(viewWidth, viewHeight, videoWidth, videoHeight, diffX, diffY, videoAspectRatio);
