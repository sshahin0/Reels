...
import com.daasuu.mp4compose.camerarecorder.capture.MediaAudioEncoder;
import com.daasuu.mp4compose.camerarecorder.capture.MediaEncoder;
import com.daasuu.mp4compose.camerarecorder.capture.MediaMuxerCaptureWrapper;
...
public class GPUCameraRecorder {
    ...
    private void destroyPreview() {
        ...
        if (glPreviewRenderer != null) {
            GlPreviewRenderer.runInternalProcess = false;
