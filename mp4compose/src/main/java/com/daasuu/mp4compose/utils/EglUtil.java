...
public class EglUtil {
    ...
    public static void updateBufferData(final int bufferName, final FloatBuffer data) {
        ...
        GLES20.glBufferData(GL_ARRAY_BUFFER, data.capacity() * FLOAT_SIZE_BYTES, data, GL_DYNAMIC_DRAW);
    ...
    public static float randomValue(final float min, final float max) {
    ...
    public static void deleteOESTexture(int textureID) {
        int[] textures = new int[1];
