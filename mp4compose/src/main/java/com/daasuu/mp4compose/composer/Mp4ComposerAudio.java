...
public class Mp4ComposerAudio {

    private final static String TAG = Mp4ComposerAudio.class.getSimpleName();
    ...
    public Mp4ComposerAudio(@NonNull final String srcPath, @NonNull final String destPath) {
        this.srcDataSource = new FilePathDataSource(srcPath, logger, errorDataSource);
        this.destPath = destPath;
    }

    public Mp4ComposerAudio(@NonNull final FileDescriptor srcFileDescriptor, @NonNull final String destPath) {
        this.srcDataSource = new FileDescriptorDataSource(srcFileDescriptor);
        this.destPath = destPath;
    }

    public Mp4ComposerAudio(@NonNull final Uri srcUri, @NonNull final String destPath, @NonNull final Context context) {
        this.srcDataSource = new UriDataSource(srcUri, context, logger, errorDataSource);
        this.destPath = destPath;
    }

    @TargetApi(Build.VERSION_CODES.O)
    public Mp4ComposerAudio(@NonNull final FileDescriptor srcFileDescriptor, @NonNull final FileDescriptor destFileDescriptor) {
    ...
    @TargetApi(Build.VERSION_CODES.O)
    public Mp4ComposerAudio(@NonNull final Uri srcUri, @NonNull final FileDescriptor destFileDescriptor, @NonNull final Context context) {
        if (Build.VERSION.SDK_INT < 26) {
            throw new IllegalArgumentException("destFileDescriptor can not use");
        }
        this.srcDataSource = new UriDataSource(srcUri, context, logger, errorDataSource);
    ...
    public Mp4ComposerAudio filter(@NonNull GlFilter filter) {
        this.filter = filter;
        return this;
    }

    public Mp4ComposerAudio size(int width, int height) {
        this.outputResolution = new Size(width, height);
        return this;
    }

    public Mp4ComposerAudio videoBitrate(int bitrate) {
        this.bitrate = bitrate;
        return this;
    }

    public Mp4ComposerAudio mute(boolean mute) {
        this.mute = mute;
        return this;
    }

    public Mp4ComposerAudio flipVertical(boolean flipVertical) {
        this.flipVertical = flipVertical;
        return this;
    }

    public Mp4ComposerAudio flipHorizontal(boolean flipHorizontal) {
        this.flipHorizontal = flipHorizontal;
        return this;
    }

    public Mp4ComposerAudio rotation(@NonNull Rotation rotation) {
        this.rotation = rotation;
        return this;
    }

    public Mp4ComposerAudio fillMode(@NonNull FillMode fillMode) {
        this.fillMode = fillMode;
        return this;
    }

    public Mp4ComposerAudio customFillMode(@NonNull FillModeCustomItem fillModeCustomItem) {
    ...
    public Mp4ComposerAudio listener(@NonNull Listener listener) {
        this.listener = listener;
        return this;
    }

    public Mp4ComposerAudio timeScale(final int timeScale) {
     ...
     */
    public Mp4ComposerAudio logger(@NonNull final Logger logger) {
        this.logger = logger;
        return this;
    }
     ...
     * @return The composer instance.
     */
    public Mp4ComposerAudio trim(final long trimStartMs, final long trimEndMs) {
    ...
    public Mp4ComposerAudio start() {
        getExecutorService().execute(new Runnable() {
            ...
            public void run() {
                ...
                Mp4ComposerAudioEngine engine = new Mp4ComposerAudioEngine(logger);

                engine.setProgressCallback(new Mp4ComposerAudioEngine.ProgressCallback() {
                    @Override
                ...
                if(videoRotate!= null && videoRotate != 0){
                    rotation = Rotation.fromInt(videoRotate);
                }
