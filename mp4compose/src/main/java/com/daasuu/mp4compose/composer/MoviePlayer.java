...
public class MoviePlayer {
     ...
     * @throws IOException
     */
    public MoviePlayer(String sourceFile, Surface outputSurface, FrameCallback frameCallback)
            throws IOException {
        mSourceFile = sourceFile;
        this.context = null;
        flag = 1;
        setUp(outputSurface, frameCallback);
    }


    public MoviePlayer(Context context, int resId, Surface outputSurface, FrameCallback frameCallback)
            throws IOException {
        mResId = resId;
        mSourceFile = "";
    ...
    private void setUp(Surface outputSurface, FrameCallback frameCallback)
            throws IOException {
    ...
    private void setUpExtractor() throws IOException {
        ...
        try {
            ...
            if (flag == 1) {
                ...
                final AssetFileDescriptor afd = context.getResources().openRawResourceFd(mResId);
    ...
    private void doExtract(MediaExtractor extractor, int trackIndex, MediaCodec decoder,
        ...
        while (!outputDone) {
            ...
            if (!GPUPlayerRenderer.runInternalProcess) {
                mIsStopRequested = true;
            }

            if (!DecoderSurface.runInternalProcess) {
                mIsStopRequested = true;
            }
