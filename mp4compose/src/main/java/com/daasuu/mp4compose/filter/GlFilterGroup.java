...
public class GlFilterGroup extends GlFilter {
    ...
    private void setCollection(final Collection<GlFilter> glFilters) {
        filters = glFilters;
    }

    public void setFilters(final GlFilter... glFilters) {
        setCollection(Arrays.asList(glFilters));
    }
    ...
    private void updateMergeFilter() {
        if (filters != null) {
    ...
    protected void addFilter(GlFilter filter) {
        if (filter == null)
            return;
    ...
    protected Collection<GlFilter> getFilters() {

        return filters;
    }

    protected void margedFilters() {
        updateMergeFilter();
    }
