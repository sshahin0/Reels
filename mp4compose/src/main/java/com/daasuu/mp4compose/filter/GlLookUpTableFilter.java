...
public class GlLookUpTableFilter extends GlFilter {
    ...
    public GlLookUpTableFilter(Bitmap bitmap) {
        ...
        hTex = com.daasuu.gpuv.egl.EglUtil.NO_TEXTURE;
    }
    ...
    private void loadTexture() {
        if (hTex == com.daasuu.gpuv.egl.EglUtil.NO_TEXTURE) {
            hTex = com.daasuu.gpuv.egl.EglUtil.loadTexture(lutTexture, com.daasuu.gpuv.egl.EglUtil.NO_TEXTURE, false);
        }
    }
