...
public class GlGlitchOneWithTime extends GlFilterWithTime {
    ...
    public GlGlitchOneWithTime() {
        ...
        shiftedForMasking1.setOffsetPosition(-0.030f, 0);
        ...
        shiftedForMasking3.setOffsetPosition(0.030f, 0);
