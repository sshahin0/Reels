...
public class GlFilter {
    ...
    private static float[] DEFAULT_VERTICES_DATA = new float[]{
            // X, Y, Z, U, V
            -1.0f, 1.0f, 0.0f, 0.0f, 1.0f,
            1.0f, 1.0f, 0.0f, 1.0f, 1.0f,
            -1.0f, -1.0f, 0.0f, 0.0f, 0.0f,
    ...
    public static void resetFilter() {
        System.arraycopy(DEFAULT_VERTICES_DATA, 0, VERTICES_DATA, 0, DEFAULT_VERTICES_DATA.length);
    }
    ...
    protected final float[] getVerticesData() {

        return VERTICES_DATA.clone();
    }
